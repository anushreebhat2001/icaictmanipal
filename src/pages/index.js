  ...
  return ( 
    <div>  
      ...
      <div className = 'section21'>
            ...
            <p className='divi'>ICAICT 2022 is a non-profit conference and it will provide an opportunity to the practicing engineers, academicians and researchers to meet in a forum to discuss various issues and its future direction in the field of Computing and Inteligent Engineering and Technologies. The conference aims to put together the experts from the relevant areas to disseminate their knowledge and experience for the relevant future research scope.</p>
            <h3 className='head1'>Organized By:<br/></h3>
      ...
      <div class="mapouter">
        <div class="gmap_canvas">
          ...
          <p className='divpara'>List Media, Academic Partners<br/><br/></p>
      </div>
    </div>  
  );
};
